...
void sparse_mul(int* Ap, int* Bp, int* Cp, int* Ai, int* Bi, int* Ci, double* Ax, double* Bx, double* Cx, int Cr, int Cc);
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  /** check input-output numbers */
    ...
    sparse_mul(Ap, Bp, Cp, Ai, Bi, Ci, Ax, Bx, Cx, Cr, Cc);
